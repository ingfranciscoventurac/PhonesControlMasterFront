...
@Component({
  ...
  templateUrl: './newLicenseGroupModal.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class NewLicenseGroupModalComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.newLicenseForm = this.fb.group({
      ...
      purchaseDate: [{ value: "", disabled: false }, Validators.required],
      warrantyExpirationDate: [{ value: "", disabled: false }, Validators.required],
    });
  ...
  saveNewLicenseGroup() {
    ...
    const purchaseDate = new Date(this.newLicenseForm.get("purchaseDate")?.value); // 👈 always returns a Date
    const warrantyExpirationDate = new Date(this.newLicenseForm.get("warrantyExpirationDate")?.value); // 👈 always returns a Date
    ...
    {
      "userId": this.newLicenseForm.get("userId")?.value,
      "typeId": Number(this.newLicenseForm.get("typeId")?.value),
      "name": this.newLicenseForm.get("name")?.value,
